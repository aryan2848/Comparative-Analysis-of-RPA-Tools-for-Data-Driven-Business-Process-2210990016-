...
│   └── Datasets
├── Report/
│   ├── 2210990016_Aaryan Saini_COOP2_Projectreport.doc
│   └── 2210990016_Aaryan Saini_COOP2_Presentation.pptx
├── Documents/
...
This project presents a comparative analysis of four major RPA platforms:
...
🛠️ Development effort and workflow complexity analysis
📈 Enterprise integration and automation capability evaluation
🧪 Methodology
Benchmark Dataset Preparation — Structured datasets for business automation tasks
Experimental Setup — Same hardware and software configuration for all platforms
Task Implementation — Data entry, report generation, and email processing workflows
...
# Execute benchmark workflows
📬 Contact

Aaryan Saini — aaryan16.be22@chitkara.edu.in

Dr. Shikha Tuteja (Supervisor) — shikha.1290@chitkara.edu.in
